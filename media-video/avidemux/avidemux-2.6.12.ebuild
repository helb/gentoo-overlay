...
# $Header: /var/cvsroot/gentoo-x86/media-video/avidemux/avidemux-2.6.8.ebuild,v 1.3 2015/01/06 19:41:55 mrueg Exp $
...
if [[ ${PV} == *9999* ]] ; then
	KEYWORDS=""
	EGIT_REPO_URI="git://github.com/mean00/${PN}2.git"
